...
class Weapon3: SKSpriteNode{
    let arrayWeapon3 = ["object10W", "weaponScorpio3", "object12Y", "weaponCapricorn3", "weaponAquarius3", "pisces", "weaponAries1", "taurus", "gemini2", "weaponCancer3", "lion1", "objectCoinGreen"]
    var type: Int
    
    init(type: Int){
        self.type = type
        let texture = SKTexture(imageNamed: arrayWeapon3[type])
        ...
        self.physicsBody?.categoryBitMask  = ColliderType.weapon3.rawValue
        self.physicsBody?.collisionBitMask = ColliderType.weapon3.rawValue
        //self.setScale(1.0)
    }
