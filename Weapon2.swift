...
class Weapon2: SKSpriteNode{
    let arrayWeapon2 = ["object10W", "weaponScorpio2", "object12X", "capricorn1", "aquarius2", "pisces", "weaponAries1", "weaponTaurus2", "gemini2", "weaponCancer2", "lion1", "objectCoinGreen"]
    var type: Int
